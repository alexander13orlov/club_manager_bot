...
def register_admin_handlers(dp, user_service: UserService):
    ...
    async def cmd_users(message: Message):
        ...
        for u in users:
            text_lines.append(f"• {u.user_id} — {u.full_name or 'Без имени'} - {u.fio or ''} ")
        ...
        with open(csv_path, "w", newline="", encoding="utf-8") as f:
            ...
            writer.writerow(["user_id", "full_name", "username", "fio", "birth_date", "gender", "phone", "email",  "created_at", "updated_at"])
            for u in users:
                writer.writerow([u.user_id, u.full_name, u.username, u.fio, u.birth_date, u.gender, u.phone, u.email,  u.created_at, u.updated_at])
